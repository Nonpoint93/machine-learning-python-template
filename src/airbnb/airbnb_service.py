...
class Airbnb:
    ...
    def delete_irrelevant_information(self, dataframe: pd.DataFrame) -> pd.DataFrame:
    ...
    def delete_duplicate_values(self, dataframe: pd.DataFrame) -> pd.DataFrame:
    ...
    def display_analysis_categorical(self, dataframe):
    ...
    def display_analysis_correlation(self, dataframe):
    ...
    def remove_outliers(self, dataframe, column) -> pd.DataFrame:
        """ Eliminar outliers """
    ...
    def process_data(self):
        ...
        dataframe = self.delete_duplicate_values(dataframe)
        ...
        dataframe = self.remove_outliers(dataframe=dataframe, column="price")
        dataframe = self.remove_outliers(dataframe=dataframe, column="minimum_nights")
        dataframe = dataframe[dataframe['minimum_nights'] <= 15 ]
        dataframe = dataframe[dataframe['price'] > 0]

        dataframe = self.delete_irrelevant_information(dataframe)
        ...
        self.display_analysis_categorical(dataframe=dataframe)
        self.display_analysis_numerical_values(dataframe=dataframe)
        self.display_analysis_correlation(dataframe)